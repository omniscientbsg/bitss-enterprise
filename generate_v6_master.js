...
const milestoneTable = () => {
  ...
  return new Table({
    ...
    rows:[
      new TableRow({ children:[hdr("Cycle",1200), hdr("Milestone Deliverable",6360), hdr("Amount (INR)",1800)] }),
...
const doc = new Document({
  ...
  sections:[{
    ...
    children:[
      ...
      para([run("Vioratech expressly agrees that it shall not, during the active 1-year development term of this Agreement: (a) share, distribute, forward, or otherwise make available the proprietary technical blueprints, AI prompt engineering scripts, or system architecture diagrams provided by BITSS to any third-party development agency or individual developer without explicitly retaining BITSS. This restriction automatically dissolves upon successful completion of the 1-year project engagement.", {size:20})], {before:0, after:120}),

      heading2("9.3 — Term & Survival"),
      para([run("The confidentiality obligations under this Agreement shall commence on the date of execution and shall survive the termination or completion of the project, remaining in full force and effect for a period of two (2) years from the date of execution. The non-compete provisions regarding the hiring of third-party development agencies using BITSS proprietary blueprints shall terminate entirely upon the successful completion of the 1-year project engagement.", {size:20})], {before:80, after:120}),
      ...
      para([run("Intellectual property rights for each specific module shall automatically transfer to Vioratech upon the successful clearance of the associated milestone payment. Upon final payment of Phase 1, Vioratech receives an irrevocable, perpetual license to modify, share, and build upon the Phase 1 codebase with any third-party developers, ensuring no vendor lock-in.", {size:20})], {before:0, after:80}),
      para([run("Code Access & Dual-Repository Escrow: To ensure complete transparency and code security for Vioratech, BITSS will maintain two separate GitHub repositories. Repository A is the active Development environment controlled by BITSS. Repository B is a Client-Access repository. Upon the clearance of each milestone payment, the approved codebase for that specific milestone will be immediately synced to Repository B, granting Vioratech immediate read-only access to the source code they have paid for. Once the final milestone is paid, full administrative rights to Repository B transfer to Vioratech.", {size:20})], {before:0, after:120}),
      ...
      new Table({
        ...
        rows:[
          new TableRow({children:[
            ...
            cell("",{width:1800,fill:DARK_GREEN,bold:true,size:18,color:WHITE,borders:allBorders(DARK_GREEN,2),align:AlignmentType.CENTER}),
            cell("Amount (INR)",{width:1800,fill:DARK_GREEN,bold:true,size:18,color:WHITE,borders:allBorders(DARK_GREEN,2),align:AlignmentType.CENTER}),
          ]}),
          new TableRow({children:[
            ...
            cell("",{width:1800,fill:LIGHT_GOLD,size:18,align:AlignmentType.CENTER}),
          ...
          new TableRow({children:[
            ...
            cell("TOTAL AMOUNT DUE",{width:5040,fill:DARK_GREEN,bold:true,size:22,color:WHITE,align:AlignmentType.RIGHT,borders:allBorders(DARK_GREEN,2)}),
            cell("",{width:1800,fill:DARK_GREEN,borders:allBorders(DARK_GREEN,2)}),
            cell("₹ 1,50,000",{width:1800,fill:GOLD,bold:true,size:22,color:WHITE,align:AlignmentType.CENTER,borders:allBorders(GOLD,2)}),
          ]}),
        ],
      }),
      ...spacer(2),
      ...
      new Table({
        ...
        rows:[
          ...["Section 1 — Executive Summary & Scope (Lean MVP)",
              ...
              "Section 9 — Non-Disclosure Agreement (NDA) — 1-Year Term",
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("C:\\Users\\Admin\\Downloads\\Vioratech_Business_Proposal_Final_V6.docx", buffer);
