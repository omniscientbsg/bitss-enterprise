...
// Fix the container wrapper logic
content = content.replace('<>\\n      <Navbar />\\n      <main className="flex-1 pt-32 px-6 max-w-7xl mx-auto w-full min-h-[80vh]">', 
'<div className="bg-void font-body text-text relative min-h-screen overflow-x-hidden selection:bg-accent2/30 selection:text-white pb-32">\\n      <Navbar />\\n      <main className="pt-[140px] lg:pt-[200px] px-6 lg:px-16 max-w-[1200px] mx-auto w-full min-h-[80vh]">');
content = content.replace('<Footer />\n    </>', '<Footer />\n    </div>');

content = content.replace('text-slate-50 mb-8', 'font-display font-medium text-[clamp(48px,6vw,84px)] text-white leading-[1.05] tracking-tight mb-8');
content = content.replace('text-slate-400 text-lg max-w-3xl leading-relaxed mb-12', 'text-[16px] text-white/60 max-w-[600px] leading-[1.8] font-light mb-16');
