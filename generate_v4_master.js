...
const milestoneTable = () => {
  ...
  const rows = [
    ...
    ["Cycle 2", "3D Animation & VFX Delivery (Frontend Assets)", "₹ 1,50,000"],
...
const doc = new Document({
  ...
  sections:[{
    ...
    children:[
      ...
      para([run("Intellectual property rights for each specific module or deliverable (e.g., UI/UX designs, Backend services) shall automatically and exclusively transfer to Vioratech upon the successful clearance of the associated milestone payment for that specific deliverable. Full platform IP transfers completely to Vioratech upon the successful completion of all Phase 1 payments.", {size:20})], {before:0, after:120}),
      ...
      para([run("Critical Rule: Change Requests will not block the sign-off and payment processing of the current milestone. Change Requests shall be formally logged, independently estimated by BITSS, and billed separately under a formal Change Order document.", {size:20, bold:true, color:"C00000"})], {before:0, after:120}),
      ...
      heading2("12.2 — Indemnification"),
      para([run("Vioratech hereby fully, unconditionally, and irrevocably indemnifies and holds harmless BITSS and Baljinder Singh from any regulatory fines imposed by the Data Protection Board of India, or any civil lawsuits arising from data breaches, missing user consents, or misuse of the platform by end-users. BITSS's liability is strictly limited to implementing the industry-standard encryption protocols specified above during the development lifecycle.", {size:20})], {before:80, after:120}),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("C:\\Users\\Admin\\Downloads\\Vioratech_Business_Proposal_Final_V4.docx", buffer);
